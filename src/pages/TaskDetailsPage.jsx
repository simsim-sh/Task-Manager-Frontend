...
const TaskDetailsPage = () => {
  ...
  // {
  //   taskByID?.status === "Onhold" && (
  //     <div className="mt-4">
  //       <p>
  //         <strong>Onhold Reason:</strong> {taskByID?.onHoldReason}
  //       </p>
  //       <p>
  //         <strong>Description:</strong> {taskByID?.onHoldDescription}
  //       </p>
  //     </div>
  //   );
  // }
      ...
      <div className="flex-1 ml-12 sm:ml-12 md:ml-[15rem] lg:ml-64 flex flex-col">
        ...
        <div className="flex p-4 justify-center items-center w-full">
          <div className="flex flex-col justify-start items-start w-[50%]">
            ...
            <h1>hours :</h1>
            <h1>category :</h1>
            <h1>assignedToWork :</h1>
            <h1>assignedTo :</h1>
          </div>
          <div className="flex flex-col justify-start items-start w-[50%]">
            <h1>{taskByID?.taskName}</h1>
            <h1>{taskByID?.title}</h1>
            <h1>{taskByID?.status}</h1>
            <h1>{taskByID?.priority}</h1>
            <h1>{taskByID?.hours}</h1>
            <h1>{taskByID?.category}</h1>
            <h1>{taskByID?.assignedToWork}</h1>
            <h1>{taskByID?.assignedTo}</h1>
          </div>
        </div>
        {/* Main content */}
                ...
                <div className="w-full md:w-1/1 bg-white rounded-lg p-5 border border-gray-200 shadow-md">
                  ...
                  <div className="flex justify-between mb-4 p-3 bg-gray-50 rounded-lg">
                    ...
                    <div className="text-right">
                      {taskByID?.categories?.map((category, index) => (
                        <div
                          key={index}
                      ...
                      <tbody>
                        ...
                        <tr className="border-b border-gray-100">
                          ...
                          {/* <td className="text-sm py-3 px-3 text-right">
                            {taskByID?.assignedTo?.map((person, index) => (
                              <div
                                key={index}
                        ...
                        <tr>
                          <td className="text-sm py-3 px-3 bg-gray-50 font-medium flex items-center gap-2">
                           ...
                           <td className="text-sm py-3 px-3 text-right text-gray-700">
                            {taskByID?.notifyBy.map((method, index) => (
                              <span
                                key={index}
