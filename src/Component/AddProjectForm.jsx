...
const AddProjectForm = () => {
  ...
  const recentProjects = [
    { id: 1, title: "Website Redesign", category: "Web Development", progress: 75, client: "ABC Corp" },
    { id: 2, title: "Mobile App Development", category: "Mobile", progress: 40, client: "XYZ Inc" },
    { id: 3, title: "E-commerce Platform", category: "Web Development", progress: 90, client: "123 Industries" },
    { id: 4, title: "Brand Identity Design", category: "Design", progress: 60, client: "Best Company" }
  ];

  // Mock data for team activities
  const teamActivities = [
    { id: 1, user: "Akash Upadhyay", action: "added a new task", time: "10 minutes ago", project: "Website Redesign" },
    { id: 2, user: "Akash Upadhyay", action: "completed a milestone", time: "2 hours ago", project: "Mobile App" },
    { id: 3, user: "Akash Upadhyay", action: "updated project status", time: "Yesterday", project: "E-commerce" },
    { id: 4, user: "Akash Upadhyay", action: "added a comment", time: "2 days ago", project: "Brand Identity" }
  ];
        ...
        <div className="p-4 md:p-6">
            ...
            <ol className="inline-flex items-center space-x-1 md:space-x-3">
              ...
              <li aria-current="page">
                <div className="flex items-center">
                  ...
                  <span className="ml-1 text-sm font-medium text-blue-600 md:ml-2">Add New Project</span>
                </div>
              </li>
            </ol>
          </nav>
          ...
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="w-full lg:w-7/12">
              <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-md md:p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-blue-600 mb-1">PROJECT CATEGORY</label>
                    <select
                ...
                <div className="mb-6">
                  <label className="block text-sm font-medium text-blue-600 mb-1">PROJECT DESCRIPTION</label>
                  <textarea
                ...
                <div className="mb-6">
                  <label className="block text-sm font-medium text-blue-600 mb-1">PROJECT SUB CATEGORY</label>
                  <div className="flex flex-wrap gap-4">
                    ...
                    <div className="flex items-center">
                      <input
                        ...
                        className="mr-2"
                      />
                      <label htmlFor="development2" className="text-sm">DEVELOPMENT</label>
                    </div>
                    ...
                    <div className="flex items-center">
                      <input
                        ...
                        className="mr-2"
                      />
                      <label htmlFor="development3" className="text-sm">DEVELOPMENT</label>
                    </div>
                    ...
                    <div className="flex items-center">
                      <input
                        ...
                        className="mr-2"
                      />
                      <label htmlFor="development4" className="text-sm">DEVELOPMENT</label>
                    </div>
                  </div>
                </div>
                
                <div className="mb-6">
                  <h3 className="text-sm font-medium text-blue-600 mb-3">CLIENT DETAILS</h3>
                ...
                <div className="mb-6">
                  <h3 className="text-sm font-medium text-blue-600 mb-3">ASSIGNED TO</h3>
                    ...
                    {team.map((member) => (
                      <div key={member.id} className="flex items-center">
                        <input
                          ...
                          onChange={(e) => handleCheckboxChange(e, 'assignedTo')}
                          className="mr-2"
                        />
                        <label htmlFor={`member-${member.id}`} className="text-sm">{member.name}</label>
                      </div>
                    ))}
                  </div>
                ...
                <div className="mb-6">
                  <h3 className="text-sm font-medium text-blue-600 mb-3">TASK & NOTES (OPTIONAL)</h3>
            ...
            <div className="w-full lg:w-5/12 space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-md p-4 md:p-6">
                <h2 className="text-lg font-semibold text-blue-600 mb-4">Project Summary</h2>
              ...
              {/* Recent Projects */}
              <div className="bg-white rounded-lg shadow-md p-4 md:p-6">
                <h2 className="text-lg font-semibold text-blue-600 mb-4">Recent Projects</h2>
                ...
                <div className="space-y-4">
                  {recentProjects.map(project => (
                    <div key={project.id} className="border border-gray-200 rounded-lg p-3">
                      ...
                      <div className="text-right text-xs text-gray-600 mt-1">{project.progress}% Complete</div>
                    </div>
                  ))}
                </div>
              </div>
